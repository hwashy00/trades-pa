...
"day_rate": float(data.get("day_rate", "0").replace("£", "").replace(",", "").strip()),
"half_day_rate": float(data.get("half_day_rate", "0").replace("£", "").replace(",", "").strip()),
"hourly_rate": float(data.get("hourly_rate", "0").replace("£", "").replace(",", "").strip()),
