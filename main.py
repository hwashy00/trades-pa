...
def assistant():
    try:
        ...
        system_prompt = (
            ...
            "You can also help with social media: if they ask you to make or write a post (usually about a job they've just finished), write ONE short, upbeat caption in their voice \u2014 1-3 sentences, a couple of tasteful emojis are fine, never include customer names or invented prices \u2014 and tell them they can tap the + button and choose 'Make a post' to add photos and share it. Never say you can't do social posts. "
...
def assistant_stream():
    ...
    system_prompt = (
        ...
        "Today is " + today + ". You help them stay on top of admin hands-free while they work. "
        "You can create quotes and invoices, check and add diary bookings, read enquiries, and mark invoices paid using your tools. "
        "You can also help with social media: if they ask you to make or write a post about a finished job, write ONE short upbeat caption in their voice (1-3 sentences, a couple of emojis fine, no customer names or invented prices) and mention they can tap + then 'Make a post' to add photos. Never say you can\u2019t do social posts. "
        "Be brief, warm and practical — like a sharp office manager. Confirm actions in one short sentence. "
